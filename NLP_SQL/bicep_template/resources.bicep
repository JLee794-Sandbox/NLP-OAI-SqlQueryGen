...
param adminName string = 'nlpdemo'
...
resource sqlServer 'Microsoft.Sql/servers@2022-11-01-preview' = {
  ...
  location: location
  properties: {
    administratorLogin: adminName // Set the administrator login for the SQL Server
    administratorLoginPassword: adminPassword // Set the administrator login password for the SQL Server
  }
}
